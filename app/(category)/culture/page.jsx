...
const fallbackCulture = Array.from({ length: 20 }).map((_, i) => ({
  id: i + 1,
  title: `Culture Story ${i + 1}`,
  slug: `culture-story-${i + 1}`,
  date: "2025-08-28",
  summary:
    "This is a demo summary for culture news. Covers arts, heritage, and traditions.",
  image: "https://source.unsplash.com/800x400/?culture,arts",
  author: "Demo Author",
}));
